...
namespace AIBridge {
    ...
    // memory keeps a predicted active/bench split so the scorer maps actions to
    // the species that should actually be in the back right now.
    inline u64 roster_state_ptr = 0;
    inline bool roster_initialized = false;
    inline u16 roster_species[6] = {0, 0, 0, 0, 0, 0};
    inline bool roster_active[6] = {false, false, false, false, false, false};
    inline u32 roster_commit_count = 0;
    ...
    static inline const char* KnownSpeciesName(u16 species) {
        switch (species) {
            ...
            case 724: return "Decidueye";
            case 727: return "Incineroar";
            case 730: return "Primarina";
            case 737: return "Charjabug";
            case 738: return "Vikavolt";
            case 740: return "Crabominable";
            case 743: return "Ribombee";
            case 745: return "Lycanroc";
            case 746: return "Wishiwashi";
            case 748: return "Toxapex";
            case 750: return "Mudsdale";
            case 752: return "Araquanid";
            case 754: return "Lurantis";
            case 758: return "Salazzle";
            case 760: return "Bewear";
            case 763: return "Tsareena";
            case 768: return "Golisopod";
            case 770: return "Palossand";
            case 771: return "Pyukumuku";
            case 773: return "Silvally";
            case 777: return "Togedemaru";
            case 778: return "Mimikyu";
            case 780: return "Drampa";
            case 781: return "Dhelmise";
            case 784: return "Kommo-o";
            case 797: return "Celesteela";
            case 800: return "Necrozma";
            case 812: return "Rillaboom";
            case 813: return "Scorbunny";
            case 814: return "Raboot";
            case 815: return "Cinderace";
            case 816: return "Sobble";
            case 817: return "Drizzile";
            case 818: return "Inteleon";
            case 819: return "Skwovet";
            case 820: return "Greedent";
            case 821: return "Rookidee";
            case 822: return "Corvisquire";
            case 823: return "Corviknight";
            case 824: return "Blipbug";
            case 825: return "Dottler";
            case 826: return "Orbeetle";
            case 827: return "Nickit";
            case 828: return "Thievul";
            case 829: return "Gossifleur";
            case 830: return "Eldegoss";
            case 831: return "Wooloo";
            case 832: return "Dubwool";
            case 833: return "Chewtle";
            case 834: return "Drednaw";
            case 835: return "Yamper";
            case 836: return "Boltund";
            case 837: return "Rolycoly";
            case 838: return "Carkol";
            case 839: return "Coalossal";
            case 840: return "Applin";
            case 841: return "Flapple";
            case 842: return "Appletun";
            case 843: return "Silicobra";
            case 844: return "Sandaconda";
            case 845: return "Cramorant";
            case 846: return "Arrokuda";
            case 847: return "Barraskewda";
            case 848: return "Toxel";
            case 849: return "Toxtricity";
            case 850: return "Sizzlipede";
            case 851: return "Centiskorch";
            case 852: return "Clobbopus";
            case 853: return "Grapploct";
            case 854: return "Sinistea";
            case 855: return "Polteageist";
            case 856: return "Hatenna";
            case 857: return "Hattrem";
            case 858: return "Hatterene";
            case 859: return "Impidimp";
            case 860: return "Morgrem";
            case 861: return "Grimmsnarl";
            case 862: return "Obstagoon";
            case 863: return "Perrserker";
            case 864: return "Cursola";
            case 865: return "Sirfetch'd";
            case 866: return "Mr. Rime";
            case 867: return "Runerigus";
            case 868: return "Milcery";
            case 869: return "Alcremie";
            case 870: return "Falinks";
            case 871: return "Pincurchin";
            case 872: return "Snom";
            case 873: return "Frosmoth";
            case 874: return "Stonjourner";
            case 875: return "Eiscue";
            case 876: return "Indeedee";
            case 877: return "Morpeko";
            case 878: return "Cufant";
            case 879: return "Copperajah";
            case 880: return "Dracozolt";
            case 881: return "Arctozolt";
            case 882: return "Dracovish";
            case 883: return "Arctovish";
            case 884: return "Duraludon";
            case 885: return "Dreepy";
            case 886: return "Drakloak";
            case 887: return "Dragapult";
            case 888: return "Zacian";
            case 889: return "Zamazenta";
            case 890: return "Eternatus";
            default: return "";
        }
    }
    ...
    static inline u32 NewestMoveRecordSeq() {
        u32 newest = 0;
        for (u32 i = 0; i < move_record_count; i++) {
            if (move_records[i].last_seen_seq > newest) newest = move_records[i].last_seen_seq;
        }
        return newest;
    }
    ...
    static inline s32 BestMoveSummaryScore() {
        ...
        for (u32 i = 0; i < move_record_count; i++) {
            const MoveScoreRecord& r = move_records[i];
            if (!IsFreshMoveRecord(r)) continue;
    ...
    static inline bool MoveSummaryIncludesTargetSpecies(u16 species) {
        for (u32 i = 0; i < move_record_count; i++) {
            const MoveScoreRecord& r = move_records[i];
            if (!IsFreshMoveRecord(r)) continue;
            if (r.target_species == species) return true;
        }
        return false;
    }
    ...
    static inline s32 RosterSlotForSpecies(u16 species, bool prefer_active) {
        ...
        for (u32 i = 0; i < 6; i++) {
            if (roster_species[i] == species && roster_active[i] == prefer_active) return static_cast<s32>(i);
        }
        for (u32 i = 0; i < 6; i++) {
            if (roster_species[i] == species) return static_cast<s32>(i);
        }
        return -1;
    }

    static inline void ClearRosterState() {
        roster_initialized = false;
        for (u32 i = 0; i < 6; i++) {
            roster_species[i] = 0;
            roster_active[i] = false;
        }
        roster_commit_count = 0;
    }

    static inline void InitRosterIfNeeded(u64 state_ptr, const char* tag, u32 hit) {
        if (roster_state_ptr != state_ptr) {
            roster_state_ptr = state_ptr;
            ClearRosterState();
        }
        ...
        if (!team) return;
        for (u32 i = 0; i < 6; i++) {
            roster_species[i] = team->species[i];
            roster_active[i] = false;
        }
        // In doubles, the first two non-empty party positions are the initial active pair.
        u32 active_marked = 0;
        for (u32 i = 0; i < 6 && active_marked < 2; i++) {
            if (roster_species[i] != 0) {
                roster_active[i] = true;
                active_marked++;
            }
        }
        const u16 observed_active = CandidateActiveSpecies(state_ptr);
        const s32 observed_slot = RosterSlotForSpecies(observed_active, false);
        ...
        if (ShouldLog(hit)) {
            Logging.Log("[ai_bridge] %s v36_roster_init trainer=%u observed_active=%u/%s slots=%u%c,%u%c,%u%c,%u%c,%u%c,%u%c\n",
                ...
                static_cast<u32>(roster_species[2]), roster_active[2] ? '*' : '-',
                static_cast<u32>(roster_species[3]), roster_active[3] ? '*' : '-',
                static_cast<u32>(roster_species[4]), roster_active[4] ? '*' : '-',
                static_cast<u32>(roster_species[5]), roster_active[5] ? '*' : '-');
        }
    }

    static inline u16 CompactBenchSpeciesForAction(u64 state_ptr, u32 action_id, const char* tag, u32 hit) {
        InitRosterIfNeeded(state_ptr, tag, hit);
        if (!roster_initialized) return 0;
        if (action_id < 2) return 0;
        u32 wanted = action_id - 2;
        for (u32 i = 0; i < 6; i++) {
            if (roster_species[i] == 0) continue;
            if (roster_active[i]) continue;
            if (wanted == 0) return roster_species[i];
            wanted--;
        }
        return 0;
    }
    ...
    static inline u16 InferredSwitchSpeciesForAction(u64 state_ptr, u32 action_id) {
        ...
        const u16 fallback = CandidateSwitchInSpecies(state_ptr);
        const TrainerTeamDef* team = ResolveTrainerTeam(state_ptr);
        if (team && action_id < 6 && team->species[action_id] != 0) return team->species[action_id];
        return fallback;
    }

    static inline bool IsPredictedActiveSwitchDestination(u64 state_ptr, u32 action_id, const char* tag, u32 hit) {
        InitRosterIfNeeded(state_ptr, tag, hit);
        if (!roster_initialized || action_id < 2) return false;
        // If this action cannot map to a current bench species, treat it as unavailable.
        const u16 compact = CompactBenchSpeciesForAction(state_ptr, action_id, tag, hit);
    ...
    static inline void MarkCommittedSwitchV33(u64 state_ptr, u16 active_species, u32 action_id, u16 switch_species, const char* tag, u32 hit) {
        ...
        s32 to_slot = -1;
        // The switch target is the action-th compact benched slot at commit time.
        if (action_id >= 2) {
            u32 wanted = action_id - 2;
            for (u32 i = 0; i < 6; i++) {
                if (roster_species[i] == 0 || roster_active[i]) continue;
                if (wanted == 0) { to_slot = static_cast<s32>(i); break; }
                wanted--;
            }
        }
        if (to_slot < 0) to_slot = RosterSlotForSpecies(switch_species, false);
        if (from_slot >= 0) roster_active[from_slot] = false;
    ...
    static inline bool AddUniqueVisibleThreat(u16* out, u32* count, u16 species) {
        if (species == 0) return false;
        for (u32 i = 0; i < *count; i++) if (out[i] == species) return false;
    ...
    static inline bool VisibleThreatIncludes(u16 species) {
        for (u32 i = 0; i < move_record_count; i++) {
            const MoveScoreRecord& r = move_records[i];
            if (!IsFreshMoveRecord(r)) continue;
            if (r.target_species == species) return true;
    ...
    static inline bool FreshMoveRecordsIncludeSpecies(u16 species) {
        if (species == 0) return false;
        for (u32 i = 0; i < move_record_count; i++) {
            const MoveScoreRecord& r = move_records[i];
            if (!IsFreshMoveRecord(r)) continue;
    ...
    static inline bool ActiveLikelyOwnsSetupOrPriorityRole(u16 active_species) {
        switch (active_species) {
            case 475: // Gallade: Trick Room / Wide Guard in this battle.
            case 823: // Corviknight: Tailwind-style support.
            case 547: // Whimsicott: Tailwind.
            case 858: // Hatterene: Trick Room.
            case 876: // Indeedee: redirection/terrain.
            case 591: // Amoonguss: redirection/Spore.
            case 534: // Conkeldurr: priority/bulky endgame potential.
            case 448: // Lucario: priority/Steel pressure.
                return true;
            default:
                return false;
        }
    ...
    static inline bool ActiveOwnedSetupOrPriorityShouldDelaySwitch(u16 active_species) {
        if (!ActiveLikelyOwnsSetupOrPriorityRole(active_species)) return false;
        // We do not yet know exact move ownership from the move summary. This
        // function deliberately only delays known setup/priority-capable active
        // species, so a partner's Fake Out/Tailwind/Trick Room does not block the
        // current active from switching.
        if (SummaryHasMoveId(433) || SummaryHasMoveId(366)) return true; // Trick Room / Tailwind present in this active window.
        if (VisibleBoardHasSpreadOrFairyPressure() && SummaryHasMoveId(469)) return true; // Wide Guard value.
        for (u32 i = 0; i < move_record_count; i++) {
            const MoveScoreRecord& r = move_records[i];
            if (MoveIsPriorityLike(r.move_id) && r.score_sum > 0) return true;
        }
        return false;
    }
    ...
    static inline bool SpeciesCommonlyHasFakeOut(u16 species) {
        switch (species) {
            case 620: // Mienshao
            case 510: // Liepard
            case 237: // Hitmontop
    ...
    static inline bool SpeciesCommonlyHasWideGuardOrSpreadGuard(u16 species) {
        switch (species) {
            case 620: // Mienshao
            case 534: // Conkeldurr in this patch set
            case 237: // Hitmontop
            case 475: // Gallade may carry Wide Guard / Trick Room utility in custom sets
            case 681: // Aegislash often Wide Guard
                return true;
            default:
                return false;
        }
    ...
    static inline bool SpeciesCommonlySetsSpeedOrRoom(u16 species) {
        switch (species) {
            case 475: // Gallade custom TR utility
            case 858: // Hatterene
            case 199: // Slowking
            case 80:  // Slowbro
            case 823: // Corviknight Tailwind-style utility if present in custom set
            case 547: // Whimsicott
            case 468: // Togekiss Tailwind-style support
                return true;
            default:
                return false;
        }
    ...
    static inline bool ActiveHasOpeningRoleValue(u16 active_species) {
        ...
        if (SummaryHasPositivePriorityInto(0)) {
            ...
            switch (active_species) {
                ...
                case 534: // Conkeldurr Mach Punch-style role if present
                case 815: // Cinderace Quick Attack / Sucker Punch-style role
                    return true;
            }
        }
        return false;
    ...
    static inline s32 ScoreSwitchMatchupV20(u64 state_ptr, u16 active_species, u16 switch_species, const char* tag, u32 hit) {
        ...
        for (u32 i = 0; i < threat_count; i++) {
            const u16 target_species = visible_threats[i];
